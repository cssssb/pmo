 ...
 * @ver:       1.0
 * @DataTime:  2019-01-15
 * @describe:  loan_loan model class
 * ================
 */
   class loan extends model {
       public function __construct() {
        ...
        //    $database = 'pmo_loan';
        //    $data = [
        //        "page_num"=>["condition"=>"equal", "query_data"=>1,"database"=>"pmo_loan"],
        //        "page_size"=>["condition"=>"equal", "query_data"=>5,"database"=>"pmo_loan"],
        //        "project_person_in_charge_name"=>["condition"=>"equal_many", "query_data"=>["柳芳","宋丹"],"database"=>"pmo_loan"],
        //        "project_project_template_name"=>["condition"=>"equal", "query_data"=>"内训","database"=>"pmo_loan"],
        //        "submit_time"=>["condition"=>"between", "query_data"=>[1546272000,1577807999],"database"=>"pmo_loan"],
