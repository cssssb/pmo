...
class budget_controller
{
    ...
    public function project()
    {
         ...
         */
        $post = $this->data->get_post();//获得post
        $data = $this->static->project($post['id']);
        $data?$cond = 0:$cond = 1;
    ...
    public function lecturer()
    {
        ...
        $data = $this->static->lecturer($post['id']);
        $data?$cond = 0:$cond = 1;
    ...
    public function implement()
    {
        ...
        $data = $this->static->implement($post['id']);
        $data?$cond = 0:$cond = 1;
    ...
    public function travel()
    {
        ...
        $data = $this->static->travel($post['id']);
        $data?$cond = 0:$cond = 1;
