...
// new model;
	...
	public function pmo_json_list_count($condition=null){
		...
		LEFT JOIN pmo_staff_user AS sta ON header.staff_id = sta.id
		LEFT JOIN pmo_staff_user AS sta_two ON header.project_leader_id = sta_two.id
	...
	public function pmo_json_list($page_num,$page_size,$condition=null){
